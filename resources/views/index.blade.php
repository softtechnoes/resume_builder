   ...
   <div class="container">
     ...
     <div class="row">
       ...
       <div class="col-md-4">
         ...
         <div class="card card-image">
           <a target="_blank" href="examples/register-page.html">
         ...
         <div class="card card-image">
           <a target="_blank" href="examples/profile-page.html">
       ...
       <div class="col-md-4">
         ...
         <div class="card card-image">
           <a target="_blank" href="examples/landing-page.html">
     ...
     <div class="row">
       ...
       <div class="col-md-6 text-center">
         ...
         <h5 class="description">
           Paper Kit 2 PRO comes with 100 custom demo icons made by our friends from
           <a href="https://nucleoapp.com/?ref=1712" target="_blank">NucleoApp</a>. The official package contains over 20.729 icons which are looking great in combination with Paper Kit 2 PRO. Make sure you check all of them and use those that you like the most.
         </h5>
         <br/>
             ...
             <div class="card card-pricing">
               <div class="card-body">
                 ...
                 <ul>
                   ...
                   <li>
                     <b>15</b> Example Pages</li>
                   <li>
                     <b>8</b> Customised Plugins</li>
     ...
     <div class="row">
       <div class="col-md-2 ml-auto">
         <div class="testimonials-people">
           ...
           <img class="left-second-person add-animation" src="../../s3.amazonaws.com/creativetim_bucket/photos/139481/thumb47ae.jpg?1485460613" alt="" />
           <img class="left-third-person add-animation" src="../../s3.amazonaws.com/creativetim_bucket/photos/152441/thumb7503.jpg?1488233314" alt="" />
           ...
           <img class="left-sixth-person add-animation" src="../../s3.amazonaws.com/creativetim_bucket/photos/77627/thumb653f.jpg?1487360092" alt="" />
         </div>
       </div>
       <div class="col-md-6">
           ...
           <div id="carouselExampleIndicators2" class="carousel slide" data-ride="carousel">
             ...
             <div class="carousel-inner" role="listbox">
               <div class="carousel-item active">
                 <div class="card card-testimonial card-plain">
                   <div class="card-avatar">
                     <img class="img" src="../../s3.amazonaws.com/uifaces/faces/twitter/mlane/128.jpg" />
                   </div>
                   <div class="card-body">
               ...
               <div class="carousel-item">
                 <div class="card card-testimonial card-plain">
                   <div class="card-avatar">
                     <img class="img" src="../../s3.amazonaws.com/creativetim_bucket/photos/125268/thumbaf08.jpg?1497799215" />
                   </div>
                   <div class="card-body">
                     <h5 class="card-description">
       ...
       <div class="col-md-2 mr-auto">
         <div class="testimonials-people">
           <img class="right-first-person add-animation" src="../../s3.amazonaws.com/uifaces/faces/twitter/mlane/128.jpg" alt="" />
           <img class="right-second-person add-animation" src="../../s3.amazonaws.com/creativetim_bucket/photos/125268/thumbaf08.jpg?1497799215" alt="" />
           <img class="right-third-person add-animation" src="../../s3.amazonaws.com/creativetim_bucket/photos/123334/thumb8cd6.jpg?1479459618" alt="" />
           ...
           <img class="right-fifth-person add-animation" src="../../s3.amazonaws.com/creativetim_bucket/photos/18/thumbc4d4.png?1431433244" alt="" />
   ...
   <div class="container">
     <div class="row">
       <div class="title text-center">
         ...
         <p class="description">You have
           <b>Free Unlimited Updates</b> and
           <b>Premium Support</b> on each package. You also have
           <b>30 days</b> to request a refund if you're not happy with your purchase.</p>
         <br/>
       </div>
       <div class="col-md-8 ml-auto mr-auto">
         <div class="space-top"></div>
