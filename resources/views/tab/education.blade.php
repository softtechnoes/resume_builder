              ...
              @if(count($diploma)!=0)
                <p class="card-description">
                  <table class="table table-hover info_table">
                    <tr>
                      <td>Course Name</td>
                      <td><span id="diploma_course_updated"></span><span id="diploma_course_fresh">{{ $diploma[0]['course_name'] }}</span></td>
                    </tr>
                    <tr>
                      <td>College Name</td>
                      <td><span id="diploma_college_updated"></span><span id="diploma_college_fresh">{{ $diploma[0]['college'] }}</span></td>
                    </tr>
                    <tr>
                        <td>University</td>
                        <td><span id="diploma_university_updated"></span><span id="diploma_university_fresh">{{ $diploma[0]['university'] }}</span></td>
                    </tr>
                    <tr>
                        <?php 
                        $state_id=$diploma[0]['state'];
                        $state_name=App\State::where('id',$state_id)->get()->toArray();
                        ?>
                        <td>State</td>
                        <td><span id="diploma_state_updated"></span><span id="diploma_state_fresh">{{ $state_name[0]['name'] }}</span></td>
                    </tr>
                    <tr>
                      <td>Percentage</td>
                      <td><span id="diploma_percentage_updated"></span><span id="diploma_percentage_fresh">{{ $diploma[0]['percentage'] }}%</span></td>
                    </tr>
                    <tr>
                      <td>Passing Year</td>
                      <td><span id="diploma_passing_year_updated"></span><span id="diploma_passing_year_fresh">{{ $diploma[0]['passing_year'] }}</span></td>
                    </tr>
                    <tr>
                      <td>From</td>
                      <td><span id="diploma_from_updated"></span><span id="diploma_from_fresh">{{ $diploma[0]['from'] }}</span></td>
                    </tr>
                    <tr>
                      <td>To</td>
                      <td><span id="diploma_to_updated"></span><span id="diploma_to_fresh">{{ $diploma[0]['to'] }}</span></td>
                    </tr>
                    <tr>
                      <td>College Address</td>
                      <td><span id="diploma_college_address_updated"></span><span id="diploma_college_address_fresh">{{ $diploma[0]['college_address'] }}</span></td>
                    </tr>
                    <tr>
                      <td>Specialization</td>
                      <td><span id="diploma_specialization_updated"></span><span id="diploma_specialization_fresh">{{ $diploma[0]['specialization'] }}</span></td>
                    </tr>
                  </table>
                </p>
                <div class="card-footer text-center">
